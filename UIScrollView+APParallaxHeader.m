...
- (void)addParallaxWithImage:(UIImage *)image andHeight:(CGFloat)height andUrl:(NSURL *)url {
    [self addParallaxWithImage:image andHeight:height andShadow:YES andUrl:url];
}

- (void)addParallaxWithImage:(UIImage *)image andHeight:(CGFloat)height andShadow:(BOOL)shadow andUrl:(NSURL *)url{
...
- (id)initWithFrame:(CGRect)frame andShadow:(BOOL)shadow {
    if(self = [super initWithFrame:frame]) {
        ...
        [self setAutoresizingMask:UIViewAutoresizingFlexibleHeight | UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleRightMargin |UIViewAutoresizingFlexibleLeftMargin |UIViewAutoresizingFlexibleBottomMargin | UIViewAutoresizingFlexibleTopMargin];
